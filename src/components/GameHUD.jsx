...
const GameHUD = ({ activeStage, scrollToSection, brandName }) => {
  ...
  const stages = [
    ...
    { id: 'about', label: 'CHARACTER', num: '01' },
    { id: 'experiences', label: 'EXPERIENCE', num: '02' },
  ...
  const handleNavClick = (id) => {
    ...
    if (soundEnabled) {
      // Play a quick low-latency synthesis beep sound
      try {
        const audioCtx = new (window.AudioContext || window.webkitAudioContext)();
        const oscillator = audioCtx.createOscillator();
        const gainNode = audioCtx.createGain();
        oscillator.type = 'square';
        oscillator.frequency.setValueAtTime(300, audioCtx.currentTime); // Beep tone
    ...
    >
      ...
      >
            ...
            return (
              <button
                ...
                style={{
                  ...
                  padding: '4px 8px',
                  fontSize: '11px',
                  color: isActive ? 'var(--color-highlight)' : 'var(--color-text)',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          >
            {soundEnabled ? <Volume2 size={18} color="#FFF" /> : <VolumeX size={18} />}
          </button>
          ...
          <button
            ...
            className="pixel-box mobile-only cursor-pointer"
            style={{
              padding: '6px',
              backgroundColor: '#FFF',
              display: 'flex',
          ...
          >
            <div style={{ width: '22px', height: '3px', backgroundColor: 'var(--color-text)' }}></div>
            <div style={{ width: '22px', height: '3px', backgroundColor: 'var(--color-text)' }}></div>
            <div style={{ width: '22px', height: '3px', backgroundColor: 'var(--color-text)' }}></div>
          </button>
        </div>
      ...
      >
        <div 
          style={{
            ...
            backgroundImage: 'linear-gradient(90deg, var(--color-accent) 0%, #76FF7A 100%)',
      ...
      {mobileMenuOpen && (
        <div
          className="pixel-box mobile-only animate-jump"
          style={{
            backgroundColor: 'var(--bg-primary)',
            marginTop: '8px',
            padding: '16px',
            ...
            return (
              <button
                ...
                style={{
                  ...
                  width: '100%',
                  textAlign: 'left',
                  boxShadow: isActive ? 'none' : '2px 2px 0px var(--color-border)',
                }}
              >
                {stage.num} {stage.label}
              </button>
